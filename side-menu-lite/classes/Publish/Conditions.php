...
namespace SideMenuLite\Publish;

use SideMenuLite\WOWP_Plugin;
use SideMenuLite\WOWP_Public;
...
class Conditions {
	...
	public static function init( $result ): bool {
		...
		$check = apply_filters( WOWP_Plugin::PREFIX . '_conditions', $check ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.DynamicHooknameFound
